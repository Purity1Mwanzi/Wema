...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
  ...
  <div class="sidebar-brand-text mx-3">WEMA PROPERTIES</div>
</a>
...
<li class="nav-item">
  ...
  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    ...
    <h6 class="collapse-header">Details:</h6>
      ...
      <a class="collapse-item" href="house_detail.php">Unit</a>
  ...
  <a class="nav-link" href="tenants.php">
    ...
    <span>Tenants</span></a>
       ...
       <li class="nav-item">
         ...
         <i class="fas fa-analytics fa-cog"></i>
           <span>Reports</span>
         </a>
         <div id="collapseSix" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
           <div class="bg-white py-2 collapse-inner rounded">
             <h6 class="collapse-header">Details:</h6>
             <a class="collapse-item" href="payment_report.php">Monthly Payment </a>
             <a class="collapse-item" href="balance_report.php">Rental Balance</a>
           </div>
         </div>
       </li>
